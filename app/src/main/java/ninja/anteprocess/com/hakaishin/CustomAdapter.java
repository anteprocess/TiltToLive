...
/*
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.txtRank.setText(dataModel.getRank());
        switch(position) {
            case 0:
                viewHolder.info.setImageResource(R.drawable.flat_medal1);
                break;
            case 1:
                viewHolder.info.setImageResource(R.drawable.flat_medal3);
                break;
            case 3:
                viewHolder.info.setImageResource(R.drawable.flat_medal2);
                break;
            default:
                break;
        }
